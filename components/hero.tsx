//import hero-image from '../public/hero-image.png'
...
export default function Hero() {
  ...
  <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
    <div>
      <h1 className="block  text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight ">Food Delivery Platform for <span className="text-blue-600">Nigerians</span></h1>
      <p className="mt-3 text-lg text-gray-800 ">We help Nigerian Food Businesses handle food deliveries with ease and on Time.</p>
      {/* Buttons */}
      ...
      <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
        ...
        <div className="">
          <div className="flex space-x-1">
            <svg className="h-4 w-4 text-yellow-300 dark:text-gray-200" width={51} height={51} viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="mt-3 text-sm text-grey-300 dark:text-gray-200">
            <span className="font-bold">4.6</span> /5 - from 12k reviews
          </p>
          <div className="mt-5">
            {/* Star */}
            <svg className="h-auto w-16 text-gray-800 dark:text-white" width={80} height={27} viewBox="0 0 80 27" fill="red" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="relative ml-4 hidden md:flex">
      <img className=" rounded-md w-[700px] h-[300px] md:h-[500px] object-fill "  src="hero-img-resize.jpg" alt="Image Description" />
