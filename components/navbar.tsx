...
export default function Navbar() {
  return (
    <header
      className="
        px-10 flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full  text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700"
    >
      <nav
        ...
        >
          <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
            ...
            <a
              ...
              href="#"
            >
              <Button text="Request a Demo" icon={true} />
            </a>
          </div>
        </div>
      </nav>
